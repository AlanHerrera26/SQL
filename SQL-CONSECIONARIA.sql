...
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (1, '7d1c18d6-bd09-4b89-a8a1-4c78c8e16c94', 'Ronny', 'Barter', '577-390-8263');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (2, '3cb31f41-57f8-4b08-bff4-d5d6da9090c4', 'Shoshanna', 'Mougin', '359-162-2308');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (3, 'a3a1fba2-3894-4f96-9391-16cdb6514fbb', 'Gilberta', 'Glassard', '984-972-8778');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (4, '5e823018-197b-41ff-8f86-25966c3db737', 'Fanny', 'Elford', '548-955-6973');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (5, '9bf950ef-ddaf-4a52-a810-5d6685e6602d', 'Gun', 'Immings', '758-453-8318');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (6, '46fb9340-ade1-471e-a310-e36608bcbbda', 'Diahann', 'Lumley', '215-947-6086');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (7, '098cb31a-2fec-4471-8194-8e6c3d6a53ea', 'Raimondo', 'Ashleigh', '164-881-4159');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (8, 'ae372e02-8924-40fa-9fb0-b5151e2e7fd1', 'Jilli', 'Cicullo', '827-167-5093');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (9, '8f7a48f7-0bfb-4a11-b74c-65ba49246200', 'Mason', 'Abramin', '738-280-8223');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (10, 'cc829423-e393-4797-8382-00c7f6d1e53f', 'Charlene', 'Coxwell', '895-416-8103');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (11, '47f60cae-a739-418a-ac8e-2645642ac980', 'Bernice', 'Stanaway', '574-503-9036');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (12, '03124194-ec28-42ae-8f22-3d5bc31df45b', 'Leeann', 'Bulbrook', '661-576-9054');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (13, '860e1be4-659b-4bc6-8c45-ba5332f0fd81', 'Sosanna', 'Steinham', '849-111-2331');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (14, '0e2fb8cc-8875-4d86-b138-4d8d1192fc5c', 'Carlie', 'Wadman', '830-589-6852');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (15, 'e2389078-b962-4316-a478-4fb2d1f3d2e6', 'Cami', 'Longmuir', '154-412-4355');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (16, 'd96888e8-8118-42cc-8268-afbbb6b8161a', 'Mervin', 'Fittis', '196-833-1917');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (17, 'b6e34c86-1eee-4746-b22b-ba302a513702', 'Johna', 'Janu', '193-109-9359');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (18, 'b5b5a881-4e94-4778-9c51-fa0afeadbf9a', 'Virgil', 'Ruberti', '572-296-5783');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (19, 'cb72bf73-bd19-4223-b88e-923641fb60cc', 'Sella', 'Looney', '131-418-0681');
insert into empleado (id_empleado, dni, Nombres, Apellidos , telefono) values (20, '801831a7-e53d-4d0e-8800-112558070ec9', 'Maureene', 'McCorkell', '628-831-2643');
...
insert into marcas (id_marca, nombre) values (2, 'Chevrolet');
insert into marcas (id_marca, nombre) values (3, 'Lexus');
insert into marcas (id_marca, nombre) values (4, 'Lexus');
insert into marcas (id_marca, nombre) values (5, 'Buick');
insert into marcas (id_marca, nombre) values (6, 'GMC');
insert into marcas (id_marca, nombre) values (7, 'Subaru');
insert into marcas (id_marca, nombre) values (8, 'Oldsmobile');
insert into marcas (id_marca, nombre) values (9, 'GMC');
insert into marcas (id_marca, nombre) values (10, 'Mazda');
insert into marcas (id_marca, nombre) values (11, 'Pontiac');
insert into marcas (id_marca, nombre) values (12, 'Ford');
insert into marcas (id_marca, nombre) values (13, 'Chrysler');
insert into marcas (id_marca, nombre) values (14, 'Saturn');
insert into marcas (id_marca, nombre) values (15, 'Honda');



create table madelos (
	id_modelo INT,
	id_marca INT,
	nombre VARCHAR(50),
	color VARCHAR(50)
);
insert into madelos (id_modelo, id_marca, nombre, color) values (1, 1, 'GTO', 'Pontiac');
insert into madelos (id_modelo, id_marca, nombre, color) values (2, 2, 'A7', 'Audi');
insert into madelos (id_modelo, id_marca, nombre, color) values (3, 3, 'Sable', 'Mercury');
insert into madelos (id_modelo, id_marca, nombre, color) values (4, 4, 'Sable', 'Mercury');
insert into madelos (id_modelo, id_marca, nombre, color) values (5, 5, 'Azure', 'Bentley');
insert into madelos (id_modelo, id_marca, nombre, color) values (6, 6, 'Fit', 'Honda');
insert into madelos (id_modelo, id_marca, nombre, color) values (7, 7, 'Thunderbird', 'Ford');
insert into madelos (id_modelo, id_marca, nombre, color) values (8, 8, 'Cavalier', 'Chevrolet');
insert into madelos (id_modelo, id_marca, nombre, color) values (9, 9, 'Discovery', 'Land Rover');
insert into madelos (id_modelo, id_marca, nombre, color) values (10, 10, 'Accord', 'Honda');
insert into madelos (id_modelo, id_marca, nombre, color) values (11, 11, 'Legacy', 'Subaru');
insert into madelos (id_modelo, id_marca, nombre, color) values (12, 12, 'Montego', 'Mercury');
insert into madelos (id_modelo, id_marca, nombre, color) values (13, 13, 'Econoline E350', 'Ford');
insert into madelos (id_modelo, id_marca, nombre, color) values (14, 14, 'Grand Prix', 'Pontiac');
insert into madelos (id_modelo, id_marca, nombre, color) values (15, 15, 'Falcon', 'Ford');
...
SELECT genero AS 'sexo' FROM cliente;

SELECT nombres,apellidos FROM cliente WHERE telefono is  null;
...
INSERT INTO forma_pago VALUES (id_forma_pago,descripcion),(0001,'efectivo'),
(0002,'tarjeta');

call sp_vista_forma_pago();
...
--CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_vista_marcas`()
BEGIN
SELECT id_marca,nombre from marcas;

END;

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_vista_forma_pago`()
BEGIN
SELECT id_forma_pago V1,descripcion V2 from forma_pago;
END;


CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_vista_vendedor`()
BEGIN
SELECT id_empleado,dni,Nombres,Apellidos,telefono FROM empleado;
END;
...
INSERT INTO autos (id_autos
id_modelos,matricula,precio)
VALUES (insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (1, 'Corvette', 'SCFHDDBT7EG474422', '€84686,90'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (2, 'RX Hybrid', '3D73M4HL0BG950127', '€50955,82'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (3, 'Thunderbird', 'WDDEJ7KB7CA678369', '€80832,84'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (4, 'Navajo', 'WAUVT58E84A085340', '€99044,68'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (5, 'Contour', '1N4AB7AP7DN540110', '€59725,17'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (6, 'S6', '2C3CDXHG3DH266713', '54808,73€'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (7, 'Protege', '1N6AF0KY7EN575094', '€92425,73'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (8, 'G-Class', 'WA1CV74L79D361589', '€58652,09'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (9, 'V8 Vantage', 'WBAPM73539E079762', '€75254,47'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (10, 'Corona Victoria', 'WP1AA2A2XBL044520', '€59079,76'); precio) (8, 'Clase G', 'WA1CV74L79D361589', '58652,09€'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (9, 'V8 Vantage', 'WBAPM73539E079762', '€75254,47'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (10, 'Corona Victoria', 'WP1AA2A2XBL044520', '€59079,76'); precio) (8, 'Clase G', 'WA1CV74L79D361589', '58652,09€'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (9, 'V8 Vantage', 'WBAPM73539E079762', '€75254,47'); insertar en NEW.autos (id_autos, id_modelo, id_matricula, precio) valores (10, 'Corona Victoria', 'WP1AA2A2XBL044520', '€59079,76');
